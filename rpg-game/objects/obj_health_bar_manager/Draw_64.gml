...
if(global.lives > 0)
{
	...
	draw_sprite(spr_heart1, 0, 640, 0);
	...
	if(global.lives > 1)
	{
		...
		/// @DnDArgument : "sprite" "spr_heart1"
		/// @DnDSaveInfo : "sprite" "spr_heart1"
		draw_sprite(spr_heart1, 0, 720, 0);
		...
		if(global.lives > 2)
		{
			...
			/// @DnDArgument : "sprite" "spr_heart1"
			/// @DnDSaveInfo : "sprite" "spr_heart1"
			draw_sprite(spr_heart1, 0, 800, 0);
		}
	}
}
...
/// @DnDArgument : "var" "global.lives"
draw_text(825, 10, string("Lives: ") + string(global.lives));
...
draw_healthbar(600, 180, 1200, 150, global.health, $FF1919FF & $FFFFFF, $FFFF19B6 & $FFFFFF, $FFFF1928 & $FFFFFF, 0, (($FF1919FF>>24) != 0), (($FF0000FF>>24) != 0));
...
draw_text(800, 120, string("Health: ") + string(global.health));