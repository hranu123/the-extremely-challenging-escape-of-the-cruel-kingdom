...
/// @DnDVersion : 1
/// @DnDHash : 64A8DF55
/// @DnDArgument : "expr" "distance_to_object(obj_main_character_level_2) <= guard_walk_detect_range || (global.player_sprinting == true && distance_to_object(obj_main_character_level_2) <= guard_sprint_detect_range)"
if(distance_to_object(obj_main_character_level_2) <= guard_walk_detect_range || (global.player_sprinting == true && distance_to_object(obj_main_character_level_2) <= guard_sprint_detect_range))
{
	...
	/// @DnDArgument : "var" "global.has_discovered_player20"
	global.has_discovered_player20 = true;
}
...
if(global.has_discovered_player20 == true)
{
	/// @DnDAction : YoYo Games.Common.Variable
	/// @DnDVersion : 1
	/// @DnDHash : 1FCF64E4
	/// @DnDParent : 1051E1D8
	/// @DnDArgument : "expr" "point_direction(x, y, obj_main_character.x, obj_main_character_level_2.y)"
	/// @DnDArgument : "var" "direction"
	direction = point_direction(x, y, obj_main_character.x, obj_main_character_level_2.y);
