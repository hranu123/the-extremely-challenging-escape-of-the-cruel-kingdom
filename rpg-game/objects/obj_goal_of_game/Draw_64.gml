...
{
    draw_gold_black_text_centered(" that allows you to exit the kingdom from the exit located across the inside of the castle", center_x, 560);
}
if (var_intro_timer >= 1150)
{
    draw_gold_black_text_centered("and exit the kingdom to escape", center_x, 630);
}
