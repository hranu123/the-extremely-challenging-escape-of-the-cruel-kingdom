...
{
    draw_gold_white_text_centered("Welcome to the Escape of the cruel castle!", center_x, 210);
}

if (var_intro_timer >= 150)
{
    draw_gold_white_text_centered("In this game, you are required to avoid obstacles, such as guards,", center_x, 280);
}

if (var_intro_timer >= 350)
{
    draw_gold_white_text_centered("while exploring around the kingdom to determine", center_x, 350);
}

if (var_intro_timer >= 550)
{
    draw_gold_white_text_centered("where your brother's prison cell is located to help him escape", center_x, 420);
}

if (var_intro_timer >= 750)
{
    draw_gold_white_text_centered("THE MINOTAUR KING!!!", center_x, 490);
}
