...
{
    draw_gold_black_text_centered("coins, along with a keycard from one of the guards,", center_x, 490);
}

if (var_intro_timer >= 950)
{
    draw_gold_black_text_centered("(hint: spam e inside castle behind King and Queens room near guasr,)", center_x, 560);
}
if (var_intro_timer >= 1150)
{
    draw_gold_black_text_centered(" that allows you to exit the kingdom from the exit located within the castle", center_x, 630);
}
if (var_intro_timer >= 1350)
{
    draw_gold_black_text_centered("to escape", center_x, 700);
}
if (var_intro_timer >= 1470)
{
    draw_gold_black_text_centered("THE MINOTAUR KING!!!", center_x, 770);
}
