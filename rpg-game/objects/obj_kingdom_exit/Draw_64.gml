...
if(player_touching_door == true)
{
	...
	if(door_sequence_started == false)
	{
		...
		draw_text(650, 525, string("Press V to Exit Kingdom ") + "");
	}
}
...
if(door_sequence_started == true)
{
	...
	draw_text_transformed(650 + random_range(-(30 - transport_timer), (30 - transport_timer)), 525 + random_range(-(30 - transport_timer), (30 - transport_timer)), string("Exiting Kingdom.. ") + "", 1, 1, random_range(-1,1));
}