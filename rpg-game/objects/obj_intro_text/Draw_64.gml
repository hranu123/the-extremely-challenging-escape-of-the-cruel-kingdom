...
{
    draw_gold_white_text_centered("Are you capable of helping your brother successfully escape from", center_x, 210);
}

if (var_intro_timer >= 150)
{
    draw_gold_white_text_centered("The Minotaur King, Horrible Harold III, his knights, and the Queen", center_x, 280);
}

if (var_intro_timer >= 250)
{
    draw_gold_white_text_centered("or will you be captured like previous visitors!!!", center_x, 350);
}
draw_set_colour(c_white);
draw_set_alpha(1);
draw_set_halign(fa_left);
