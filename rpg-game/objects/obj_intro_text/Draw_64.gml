...
if (var_intro_timer >= 10)
{
    draw_gold_black_text_centered("Are you capable of escaping successfully from", center_x, 210);
}

if (var_intro_timer >= 150)
{
    draw_gold_black_text_centered("The Minotaur King, Horrible Harold III,", center_x, 280);
}
if (var_intro_timer >= 325)
{
    draw_gold_black_text_centered(" his knights, and the Queen", center_x, 350);
}
if (var_intro_timer >= 500)
{
    draw_gold_black_text_centered("or will you be captured like previous visitors!!!", center_x, 420);
}
