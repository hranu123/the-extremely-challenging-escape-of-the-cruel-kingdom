	...
	else
	{
	    ...
	    if (bear_trap_cooldown <= 0)
	    {
	        if (place_meeting(x, y, obj_bear_trap_1))
	        {
				...
				global.bear_trapped = true;
	            bear_escape_presses = 10;
	            player_can_move = false;
	
	            current_bear_trap = obj_bear_trap_1;
	            current_trap_damage = 40;
